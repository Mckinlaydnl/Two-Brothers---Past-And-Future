    ...
    private void Update()
    {
        ...
        if (takingDamage == false)
        {
            ...
            if (controller.isGrounded)
            {
                ...
                if (!Player2Anim.GetCurrentAnimatorStateInfo(0).IsName("Kick")
            ...
            if (Input.GetKeyDown(KeyCode.Space) && (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.LeftArrow)))
            {
